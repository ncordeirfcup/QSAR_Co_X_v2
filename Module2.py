...
def selected():
    ...
    if Criterion.get()==1:
        L11T1 ['state']='normal'
        MaxFeatures1_None['state']='normal'
        MaxFeatures1_integer['state']='normal'
        E10T1['state']='normal'
        if Criterion26.get()=='none':
           rd=None
             ...
             rd=int(E10T1.get())
        estimator=RandomForestClassifier(random_state=rd)
        rn='RF'
        param_grid['bootstrap']=[True,False]

    elif Criterion.get()==2:
        thirdLabelTabThreer2c1_h['state']='disabled'
        thirdEntryTabThreer3c1_h['state']='disabled'
        thirdEntryTabThreer3c1_h1['state']='disabled'
        thirdEntryTabThreer3c1_h2['state']='disabled'
        L11T1 ['state']='disabled'
        MaxFeatures1_None['state']='disabled'
        MaxFeatures1_integer['state']='disabled'
        ...
        rn='SVC'
         ...
         if Criterion26.get()=='none':
            rd=None
             ...
             rd=int(E10T1.get())
         estimator=GradientBoostingClassifier(verbose=1,random_state=rd)
         rn='GB'

    elif Criterion.get()==6:
         thirdLabelTabThreer2c1_h['state']='normal'
         thirdEntryTabThreer3c1_h['state']='normal'
         thirdEntryTabThreer3c1_h1['state']='normal'
         thirdEntryTabThreer3c1_h2['state']='normal'
         L11T1 ['state']='normal'
         MaxFeatures1_None['state']='normal'
         MaxFeatures1_integer['state']='normal'
         E10T1['state']='normal'
         if Criterion26.get()=='none':
            rd=None
              ...
              rd=int(E10T1.get())
         estimator=MLPClassifier(random_state=rd)
         rn='MLP'
...
Criterion_GB.place(x=195, y=130)
Criterion_MLP.place(x=325, y=130)

thirdLabelTabThreer2c1_h=Label(tab1, text='Hidden Layers (for MLP only)',font=("Helvetica", 12),state=DISABLED)
v1=IntVar(tab1,value=100)
v2=IntVar(tab1,value=0)
v3=IntVar(tab1,value=0)
thirdLabelTabThreer2c1_h.place(x=80,y=160)
thirdEntryTabThreer3c1_h=Entry(tab1,textvariable=v1,width=5,state=DISABLED)
thirdEntryTabThreer3c1_h.place(x=300,y=163)
thirdEntryTabThreer3c1_h1=Entry(tab1,textvariable=v2,width=5, state=DISABLED)
thirdEntryTabThreer3c1_h1.place(x=350,y=163)
thirdEntryTabThreer3c1_h2=Entry(tab1,textvariable=v3,width=5, state=DISABLED)
thirdEntryTabThreer3c1_h2.place(x=400, y=163)


L11T1= tk.Label(tab1, text='Random state (for MLP/RF/GB only)',font=("Helvetica", 12),state=DISABLED)
L11T1.place(x=35,y=195)
Criterion26=StringVar()
Criterion26.set('none')
MaxFeatures1_None = ttk.Radiobutton(tab1, text='None', variable=Criterion26, value='none',state=DISABLED)
MaxFeatures1_None.place(x=300,y=195)
MaxFeatures1_integer = ttk.Radiobutton(tab1, text='Number', variable=Criterion26, value='integer',state=DISABLED)
MaxFeatures1_integer.place(x=350,y=195)

E10T1 = tk.Entry(tab1, textvariable=MaxFeatures1_integer, width=7,state=DISABLED)
E10T1.place(x=420,y=198)

thirdLabelTabThreer2c1=Label(tab1, text='Correlation cut-off',font=("Helvetica", 12))
thirdLabelTabThreer2c1.place(x=154,y=230)
thirdEntryTabThreer3c1=Entry(tab1)
thirdEntryTabThreer3c1.place(x=300,y=230)

fourthLabelTabThreer4c1=Label(tab1, text='Variance cut-off',font=("Helvetica", 12))
fourthLabelTabThreer4c1.place(x=175,y=260)
fourthEntryTabThreer5c1=Entry(tab1)
fourthEntryTabThreer5c1.place(x=300,y=260)

thirdLabelTabOne=tk.Label(tab1, text="CV for grid search",font=("Helvetica", 12))
thirdLabelTabOne.place(x=150,y=290)
thirdEntryTabOne = tk.Entry(tab1, width=20)
thirdEntryTabOne.place(x=300,y=290)

forthLabelTabOne=tk.Label(tab1, text="CV for model predictability",font=("Helvetica", 12))
forthLabelTabOne.place(x=100,y=320)
forthEntryTabOne = tk.Entry(tab1, width=20)
forthEntryTabOne.place(x=300,y=320)


b2=Button(tab1, text='Generate model', command=sol,bg="orange",font=("Helvetica", 10),anchor=W, justify=LEFT)
b2.place(x=450,y=255)

fifthLabelTabOne = tk.Label(tab1, text="Select validation set",font=("Helvetica", 12))
fifthLabelTabOne.place(x=60,y=350)
fifthEntryTabOne = tk.Entry(tab1, width=40)
fifthEntryTabOne.place(x=230,y=353)
