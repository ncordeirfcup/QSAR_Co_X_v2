...
C16_1= ttk.Radiobutton(tab1, text='LBFGS', variable=Criterion7, value='lbfgs')
C15.place(x=90,y=435)
C16.place(x=160,y=435)
C16_1.place(x=90,y=460)

L10T1= tk.Label(tab1, text="Learning rate",font=("Helvetica", 10))
L10T1.place(x=10,y=480)
...
C17.place(x=90,y=480)
C18.place(x=160,y=480)
C19.place(x=90,y=500)

XL_r= tk.Label(tab1, text="Random state",font=("Helvetica", 10))
XL_r.place(x=10,y=525)
